...
\noindent There are two folders that are not strictly functional to the project:

\begin{itemize}
  \itemAR \texttt{Jupyter Notebook/} contains the files related to the first training of the machine learning model;
  \itemAR \texttt{PoC/} contains a script which can be used to get a \gls{poc} of the project, using \textit{mininet}.
\end{itemize}