...
\begin{itemize}
    ...
    \item[\faCaretRight] \textit{Unknown attack detection}: attack variants and novel attacks emerge constantly and more and more frequently, hence the need of being able to detect unknown attacks. Some \glsxtrshortpl{ids} rely on the signatures of known attacks and cannot identify new threats \cite{Hodo2017}.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Identifying useful traffic features and extracting them with the chosen \glsxtrshort{sdn} Controller;
    ...
    \item Evaluating the performance of the \glsxtrshort{ids} using an appropriate dataset.
\end{enumerate}
